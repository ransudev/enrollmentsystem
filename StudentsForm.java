...
public class StudentsForm extends javax.swing.JFrame {
    ...
    public StudentsForm() {
        ...
        this.setLocationRelativeTo(null); // Center the form on screen
    }
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        ...
        try {
            ...
            Statement stmt = MaisoEnrollmentSystem.con.createStatement();
            ...
            String currentDatabase = MaisoEnrollmentSystem.db;
            try {
    ...
    private void DeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteActionPerformed
        ...
        try {
            ...
            String[] tables = new String[] {"Students", "Subjects", "Teachers", "Enroll", "Grades", "Assign"};
            for (String tbl : tables) {
                try {
                    stmt.execute("REVOKE SELECT ON `" + currentDatabase + "`.`" + tbl + "` FROM '" + username + "'@'%' ");
                } catch (java.sql.SQLException e) {
                    if (e.getErrorCode() == 1396 || String.valueOf(e.getMessage()).toLowerCase().contains("exists")) {
                        System.out.println("User already exists: " + username + ", proceeding to grant privileges.");
                    } else {
            ...
            try { stmt.execute("FLUSH PRIVILEGES"); } catch (Exception ignore) {}

            System.out.println("Revoked database privileges for student user: " + username + " on DB: " + currentDatabase);

            stmt.close();
        } catch (Exception ex) {
            System.out.println("Failed to revoke privileges for student user: " + ex.getMessage());
            ex.printStackTrace();
        }
        showrec();
        Studid.setText("");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        // Reflect the currently selected database in the title label
        try {
            jLabel7.setText("Student Registration: " + MaisoEnrollmentSystem.db);
    ...
    private void ExitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ExitActionPerformed
        if (MaisoEnrollmentSystem.teachersFormInstance != null) {
            MaisoEnrollmentSystem.teachersFormInstance.dispose();
            MaisoEnrollmentSystem.teachersFormInstance = null;
        }
        if (MaisoEnrollmentSystem.subjectsFormInstance != null) {
            MaisoEnrollmentSystem.subjectsFormInstance.dispose();
            MaisoEnrollmentSystem.subjectsFormInstance = null;
        }

        java.awt.EventQueue.invokeLater(() -> new Login().setVisible(true));

        this.dispose();
        MaisoEnrollmentSystem.studentsFormInstance = null;
    ...
    private void firstSemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_firstSemActionPerformed
        ...
        try {
            ...
            MaisoEnrollmentSystem.st.execute("CREATE DATABASE IF NOT EXISTS `" + dbName + "`");
            MaisoEnrollmentSystem.st.execute("USE `" + dbName + "`");

            MaisoEnrollmentSystem.st.execute("CREATE TABLE IF NOT EXISTS Students ("
            ...
            MaisoEnrollmentSystem.st.execute("CREATE TABLE IF NOT EXISTS Subjects ("
            ...
            MaisoEnrollmentSystem.st.execute("CREATE TABLE IF NOT EXISTS Teachers ("
            ...
            MaisoEnrollmentSystem.st.execute("CREATE TABLE IF NOT EXISTS Enroll ("
            ...
            MaisoEnrollmentSystem.st.execute("CREATE TABLE IF NOT EXISTS Assign ("
                    + "Tid INT NOT NULL,"
            ...
            MaisoEnrollmentSystem.st.execute("CREATE TABLE IF NOT EXISTS Grades ("
            ...
            MaisoEnrollmentSystem.st.execute("CREATE TABLE IF NOT EXISTS TransactionCharges ("
            ...
            MaisoEnrollmentSystem.st.execute("CREATE TABLE IF NOT EXISTS Invoice ("
    ...
    public void showrec() {
        ...
        try {
            ...
            while (MaisoEnrollmentSystem.rs.next()) {
                ...
                String address = MaisoEnrollmentSystem.rs.getString("studadd");
                String contact = MaisoEnrollmentSystem.rs.getString("studcontact");
                String gender = MaisoEnrollmentSystem.rs.getString("studgender");
                String yrlvl = MaisoEnrollmentSystem.rs.getString("yrlvl");
    ...
    public void showEnrollRec() {
        ...
        try {
            String sql
                    ...
                    + "WHERE e.studid = " + sid + " "
                    + "ORDER BY e.subjid";
            MaisoEnrollmentSystem.rs = MaisoEnrollmentSystem.st.executeQuery(sql);
            while (MaisoEnrollmentSystem.rs.next()) {
                String[] row = {
                    MaisoEnrollmentSystem.rs.getString("SubjID"),
                    MaisoEnrollmentSystem.rs.getString("Code"),
                    MaisoEnrollmentSystem.rs.getString("Description"),
                    MaisoEnrollmentSystem.rs.getString("Units"),
                    MaisoEnrollmentSystem.rs.getString("Schedule")
                };
                model.addRow(row);
            }
        } catch (Exception ex) {

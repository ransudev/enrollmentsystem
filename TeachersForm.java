 ...
 private void TeacherTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TeacherTableMouseClicked
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        try {
            ...
            String[] tables = new String[] { "Students", "Subjects", "Teachers", "Enroll", "Grades", "Assign", "Invoice", "TransactionCharges" };
            for (String tbl : tables) {
                try {
                    stmt.execute("REVOKE SELECT, INSERT, UPDATE ON `" + currentDatabase + "`.`" + tbl + "` FROM '" + username + "'@'%' ");
                } catch (SQLException e) {
                }
            }
            try { stmt.execute("FLUSH PRIVILEGES"); } catch (Exception ignore) {}

            System.out.println("Revoked database privileges for teacher user: " + username + " on DB: " + currentDatabase);

            stmt.close();
        } catch (Exception ex) {
            System.out.println("Failed to revoke privileges for teacher user: " + ex.getMessage());
            ex.printStackTrace();
        }
    ...
    public void showrec() {
        ...
        try {
            ...
            while (MaisoEnrollmentSystem.rs.next()) {
                String tid = MaisoEnrollmentSystem.rs.getString("Tid");
                String tname = MaisoEnrollmentSystem.rs.getString("Tname");
                String tadd = MaisoEnrollmentSystem.rs.getString("Tadd");
                String tcontact = MaisoEnrollmentSystem.rs.getString("Tcontact");
                String tdept = MaisoEnrollmentSystem.rs.getString("Tdept");
